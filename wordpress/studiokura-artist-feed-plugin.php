<?php
/**
 * Plugin Name: Studio Kura Artist Feed
 * Description: Exposes a REST endpoint that scrapes Studio Kura residency artist pages and returns artist/profile-image data.
 * Version: 1.0.0
 * Author: Studio Kura
 */
...
add_shortcode('guest_artists_json', function () {
    ...
    return '<pre>' . esc_html(wp_json_encode(array(
        'success' => true,
